...
updated: 2026-04-30
type: entity
tags: [software-processing, neuroimaging, laminar-analysis, cortical-analysis, brain-segmentation]
...
- [huntenburg-2018] Huntenburg, Steele, Bazin (2018). Nighres: processing tools for high-resolution neuroimaging. GigaScience.
- [waehnert-2014] Waehnert et al. (2014). A geometric approach to cortical layering. NeuroImage.
- [han-2004] Han et al. (2004). CRUISE: Cortical Reconstruction Using Implicit Surface Evolution. NeuroImage.
- [cbs-tools] Bazin et al. (2012). CBS Tools: High-Resolution Brain Processing Tools. NeuroImage.