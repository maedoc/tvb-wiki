...
**Brainstorm** is a widely used, GUI-based software originally designed for the statistical analysis and [[source-localization]] of [[meg]] and [[eeg]] recordings [[raw/papers/semanticscholar-e06960bf0ace.md|Delaire et al. (2025)]]. It serves as an established neuroimaging platform that has inspired end-to-end analysis toolboxes such as MLE-Toolbox, which implements a unified graphical interface for raw data import, preprocessing, source localization, and [[functional-connectivity]] mapping in the tradition of Brainstorm and FieldTrip [[raw/papers/arxiv-2604.16463.md|Liu (2026)]]. Brainstorm maintains native interoperability with [[freesurfer]], [[eeglab]], and [[mne-python]], enabling seamless integration into existing electrophysiological workflows [[raw/papers/arxiv-2604.16463.md|Liu (2026)]].

The software supports tissue segmentation, anatomical atlas management, and forward and inverse modeling for both non-invasive scalp and stereotactic [[eeg]] applications, enabling precise lead-field computation and source reconstruction within multi-compartment volume conductor models [[raw/papers/arxiv-2602.00684.md|Prieto et al. (2026)]]. Its extensible architecture has fostered dedicated plugins such as NIRSTORM for functional near-infrared spectroscopy, reflecting an active ecosystem built around the core platform [[raw/papers/semanticscholar-e06960bf0ace.md|Delaire et al. (2025)]]. Together with [[eeglab]], fieldtrip, and [[mne-python]], Brainstorm is recognized as a cornerstone electrophysiology tool in modern reproducible [[neuroimaging]] environments [[raw/papers/Renton2024.md|Renton et al. (2024)]].
