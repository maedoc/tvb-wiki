...
popeye (Population REceptive Field estimAtion) is an open-source Python package for estimating population receptive field models from [[fmri]] data. In network neuroscience, researchers face a multitude of arbitrary yet defensible methodological choices when analyzing fMRI data, raising concerns about the robustness and [[reproducibility]] of findings in the absence of ground truths regarding analytical validity [[raw/papers/semanticscholar-cb501cd33451.md|Burkhardt & Gießing (2025)]]. Functional magnetic resonance imaging provides high-resolution cortical representations for characterizing brain activity patterns, though its high acquisition cost limits large-scale applications and motivates careful methodological design [[raw/papers/arxiv-2603.24176.md|Qu et al. (2026)]]. Functional connectivity matrices derived from fMRI encode large-scale neural interactions, yet existing models are often trained under single-site assumptions that make them unsuitable for real-world sequential multi-site data, resulting in limited generalization and catastrophic forgetting [[raw/papers/arxiv-2604.14259.md|Chen & Yu (2026)]].

The impact of analytical decisions on [[neuroimaging]] conclusions is substantial. Research examining atlas [[parcellation]] across six psychiatric disorders showed that frontal-related [[functional-connectivity]] deficits are reproducible regardless of atlas choice, whereas classification accuracy and pattern extraction in other regions depend heavily on the delineation method [[raw/papers/semanticscholar-6295d2445697.md|Wu et al. (2025)]]. Complementary data-driven approaches such as GLEAN identify covariation patterns in [[eeg]] and [[meg]] band-limited power through Hidden Markov Models or Independent Component Analysis, revealing robust group-level network features in resting-state electrophysiology [[raw/papers/glean-github.md|Baker et al. (2015)]]. As an open-source framework for pRF estimation, popeye aligns with the multiverse-analysis ethos of promoting transparency and best practice in the study of [[brain-dynamics]], contributing to an analytical ecosystem that includes complementary data-driven decompositions of electrophysiology and rigorous evaluation of how methodological choices shape neuroimaging inferences [[raw/papers/semanticscholar-cb501cd33451.md|Burkhardt & Gießing (2025)]].
