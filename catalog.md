...
- [[Bdftools]] – BDFtools refers to the ecosystem of software libraries for reading and processing BioSemi Data Format (BDF) files, including pybdf and pyedflib, essential for high-density EEG preprocessing in computational neuroscience workflows.
...
- [[BMTK]] – Python toolkit by Allen Institute for large-scale [[spiking-neural-networks]] construction, uses NEURON backend.
...
- [[dipde|Dipde]]
- [[dwi-toolbox|Dwi Toolbox]]
- [[eegnet|Eegnet]]
- [[exploreasl|Exploreasl]]
- [[fsl-randomise|Fsl Randomise]]
- [[gretna|Gretna]]
- [[ica-aroma|Ica Aroma]]
- [[iclabel|Iclabel]]
- [[lean|Lean]]
