...
## Related Concepts
Lopes da Silva's 1974 model is widely regarded as the first [[neural-mass-models|neural mass model]] designed specifically to simulate [[eeg]] rhythms, establishing that macroscopic alpha oscillations could emerge from the interaction of excitatory thalamocortical relay cells and inhibitory interneurons coupled through recurrent feedback loops and inhibitory post-synaptic potentials [[raw/papers/lopes-da-silva-1974.md|Lopes da Silva et al. (1974)]]. This two-population architecture demonstrated that [[brain-oscillations|brain oscillations]] need not reflect single-neuron properties but could arise from collective mesoscopic dynamics, a principle later generalized by Walter Freeman's K-set hierarchy of population models, which provided a quantitative framework for nonlinear excitatory-inhibitory interactions underlying EEG generation [[raw/papers/freeman-1975.md|Freeman (1975)]]. The model's emphasis on population-level feedback loops also supplied the template for the multi-population cortical architectures that followed [[raw/papers/jansen-rit-1995.md|Jansen & Rit (1995)]][[raw/papers/lopes-da-silva-1974.md|Lopes da Silva et al. (1974)]].

The [[jansen-rit|Jansen-Rit]] model extended Lopes da Silva's thalamic circuitry to a three-population cortical column—pyramidal cells, excitatory interneurons, and inhibitory interneurons—using alpha-shaped post-synaptic impulse responses to generate both alpha and beta rhythms [[raw/papers/jansen-rit-1995.md|Jansen & Rit (1995)]]. Because this architecture retains the core excitatory-inhibitory feedback logic while adding a pyramidal population specific to cortex, it has become the default [[neural-mass-models|neural mass]] implementation in [[tvb-library|The Virtual Brain]] for EEG and MEG simulations [[raw/papers/jansen-rit-1995.md|Jansen & Rit (1995)]][[raw/papers/lopes-da-silva-1974.md|Lopes da Silva et al. (1974)]]. This lineage—from thalamocortical alpha generation to a general-purpose cortical column framework—exemplifies how early population models were progressively refined into the architectures adopted in modern neural mass implementations [[raw/papers/jansen-rit-1995.md|Jansen & Rit (1995)]][[raw/papers/freeman-1975.md|Freeman (1975)]][[raw/papers/lopes-da-silva-1974.md|Lopes da Silva et al. (1974)]].
...
8. R. Lorenzi, Fulvia Palesi, C. Casellato, C. G. Gandini Wheeler-Kingshott, Egidio D’Angelo. (2025). *Region-specific mean field models enhance simulations of local and global brain dynamics*. bioRxiv. [DOI](https://doi.org/10.1038/s41540-025-00543-9)