...
## Key Papers
Foundational work in the [[whole-brain-modeling]] ecosystem underlying modern electrophysiology analysis dates to Sanz Leon et al. (Sanz Leon et al., 2013), whose introduction of [[the-virtual-brain]] simulator established a validated computational framework for simulating primate brain [[network-dynamics]] with [[neural-mass-models]] operating on empirical [[structural-connectivity]] matrices. Their methods for generating realistic [[resting-state]] and task-based activity have become benchmarks for linking empirical recordings to simulated outputs, demonstrating how large-scale brain dynamics can be reconstructed from structural data. Subsequent multi-scale advances by Hater et al. (Hater et al., 2025; 2026) extended this paradigm by developing Arbor-TVB, a [[co-simulation]] architecture that couples fine-grained spiking models to TVB's macroscopic [[neural-mass-models]]. Their case study of neural-level seizure generation and subsequent whole-brain propagation illustrates the computational challenges of bridging microscopic and macroscopic scales—challenges that necessitate robust preprocessing, accurate spike sorting, and unit-level characterization in the empirical data pipelines that feed such models.
## Related Software
