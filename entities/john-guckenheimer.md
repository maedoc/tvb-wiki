...
- **Dynamical Systems**: Development of computational methods for analyzing high-dimensional dynamical systems
- **Neuroscience Applications**: Application of dynamical systems theory to neural models and neural computation
- **Software**: Development of numerical tools for continuation and bifurcation analysis

## Relevance to TVB
- guckenheimer-holmes-1983 provides rigorous mathematical foundations for [[bifurcation analysis]] in neural models
- Center manifold and normal form theory essential for analyzing [[neural mass model]] dynamics
- Methods for global bifurcations inform [[epilepsy modeling]] and seizure transitions
...
6. (authors unknown). *Stochastic Dynamics in the Brain and Probabilistic Models*.
