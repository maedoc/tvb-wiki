...
Simulation-based inference (SBI) denotes a family of [[bayesian|Bayesian]] methods designed for settings where the likelihood of observed data cannot be written in closed form, yet forward simulation from a generative model remains tractable [[raw/papers/arxiv-2601.22367.md|Sun et al. (2026)]]. Rather than evaluating explicit likelihoods, SBI learns an approximate posterior distribution over model parameters from large ensembles of synthetically generated data sets [[raw/papers/arxiv-2601.22367.md|Sun et al. (2026)]]. This paradigm is especially relevant in neuroscience, where models of [[network-dynamics|network dynamics]] and [[connectomics|brain connectivity]] often involve high-dimensional coupled systems whose likelihoods are analytically inaccessible, and where conventional Bayesian estimation techniques face severe scalability limitations [[raw/papers/arxiv-2506.04558.md|Fan & White (2025)]].

Contemporary SBI replaces classical Markov-chain Monte Carlo samplers with neural networks that serve as amortized conditional density estimators [[raw/papers/arxiv-2601.22367.md|Sun et al. (2026)]]. Once trained, these estimators map from an observed data set to a posterior sample in a single forward pass, eliminating the need for per-dataset simulation or iterative MCMC at inference time [[raw/papers/arxiv-2601.22367.md|Sun et al. (2026)]]. Fan and White [[raw/papers/arxiv-2506.04558.md|(2025)]] introduced Amortised Hierarchical Sequential Neural Posterior Estimation (AHS-NPE) to target intractable likelihoods in multiple-network Exponential Random Graph Models; by preserving amortisation alongside sequential refinement, the method scales inference for resting-state [[neuroimaging-fmri|fMRI]] data to sample sizes far beyond the reach of traditional Bayesian estimation [[raw/papers/arxiv-2506.04558.md|Fan & White (2025)]]. Sun, Nicholls, and Lee [[raw/papers/arxiv-2601.22367.md|(2026)]] extended this amortization framework to Generalized Bayesian Inference, showing that a single neural posterior estimator conditioned on both data and temperature achieves competitive posterior approximations across standard SBI benchmarks including the chaotic Lorenz-96 system [[raw/papers/arxiv-2601.22367.md|Sun et al. (2026)]]. These advances position SBI as a practical inferential engine for [[whole-brain-modeling|whole-brain models]] and other complex neuroscientific simulators where [[variational-bayes|variational]] or sampling-based alternatives remain prohibitively expensive.
