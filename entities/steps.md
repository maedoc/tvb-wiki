...
4. Lingyan Yu, Fengqian Mao, Shunan Chen, K. Yu, Yani Hu, Jie Chen, Wei Hu, Zhenwei Yu, H. Dai. (2026). *Development and validation of a population pharmacokinetic model for lacosamide in adult patients with epilepsy to inform precision dosing*. BMC Pharmacology and Toxicology. [DOI](https://doi.org/10.1186/s40360-026-01114-2)
