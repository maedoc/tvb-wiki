...
## Related Concepts
The analytical frameworks that CIFTI supports rest on foundational definitions of brain connectivity established over the past three decades. [[raw/papers/friston-1993.md|Friston et al. (1993)]] defined [[functional-connectivity]] as the temporal correlation between spatially remote neurophysiological events and applied principal component analysis to PET and [[fmri]] data sets to identify functionally connected networks, establishing the statistical framework that underlies modern [[resting-state]] analyses [[raw/papers/friston-1993.md|Friston et al. (1993)]]. This early demonstration that distributed networks could be extracted from neuroimaging time series created the need for formats capable of preserving full temporal and spatial information rather than reducing data to [[brain-parcellations|parcel-based]] summaries. [[raw/papers/sporns-tononi-kotter-2005.md|Sporns et al. (2005)]] introduced the [[connectome]] as a comprehensive structural description of the network of elements and connections forming the human brain, arguing that understanding connectivity is essential for understanding brain function and emphasizing network analysis approaches [[raw/papers/sporns-tononi-kotter-2005.md|Sporns et al. (2005)]]. Their work sparked the field of connectomics and drove major initiatives like the [[human-connectome-project]], creating the theoretical requirement for unified formats that can store both [[functional-connectivity]] and [[structural-connectivity]] whole-brain data within a single anatomical frame.

Contemporary [[whole-brain-modeling]] increasingly depends on dense, grayordinate-level representations. [[raw/papers/arxiv-2603.13361.md|Gao et al. (2026)]] proposed BrainCast, a spatio-temporal forecasting framework that formulates whole-brain fMRI time series prediction as a multivariate task jointly modeling temporal dynamics within regions of interest and spatial interactions across ROIs. The framework was validated on [[resting-state]] and task [[fmri]] datasets from the [[human-connectome-project]] and captures intrinsic neural dynamics by enhancing both low- and high-energy temporal components at the ROI level [[raw/papers/arxiv-2603.13361.md|Gao et al. (2026)]]. By embedding every ROI time series as a token to characterize inter-ROI dependencies, BrainCast exemplifies how next-generation spatio-temporal models exploit dense, modality-unified data structures [[raw/papers/arxiv-2603.13361.md|Gao et al. (2026)]], bridging the gap between anatomical structure and functional dynamics in computational neuroscience pipelines.
...
8. (authors unknown). *GLEAN: Group Level Exploratory Analysis of Networks*.