...
Third, OpenMEEG supports **multiple input formats** for head geometry, including meshes from [[pysurfer]], [[brainvoyager]], and other neuroimaging packages. The output can be integrated directly with inverse solution algorithms in packages like [[mne-bids-pipeline]], Fieldtrip, and [[brainvoyager]]. This interoperability has made OpenMEEG a de facto standard in the EEG/MEG community for forward modeling.
...
OpenMEEG integrates with a rich ecosystem of neuroimaging software tools. For EEG/MEG analysis, it works closely with [[mne-bids-pipeline]], [[brainvoyager]], and Fieldtrip for complete analysis pipelines. For head modeling, it accepts meshes generated by [[pysurfer]], [[brainvoyager]], and [[Freeview]]. For inverse modeling, OpenMEEG forward solutions can be used with various inverse algorithms including minimum norm estimation, beamformers, and [[dynamic causal modeling]] approaches. Alternative forward solvers include the Finite Element Method (FEM) implementations in SimNIBS for more detailed tissue modeling.

## References

1. Sanz Leon et al. (2013). *[[tvb|The Virtual Brain]]: a simulator of primate brain [[network-dynamics]]*. Frontiers in Neuroinformatics. [DOI](https://doi.org/10.3389/fninf.2013.00010)
2. Derek A. Drumm, Guillermo Nuñez Ponasso, A. Linke, G. Noetscher, Burkhard Maess, T. Knösche, J. Haueisen, J. Lewine, Christopher Abbott, S. Makaroff, Zhi‑De Deng. (2025). *Improved Source Localization of Auditory Evoked Fields using Reciprocal BEM‑FMM*. bioRxiv. [DOI](https://doi.org/10.1101/2025.05.09.653081)
