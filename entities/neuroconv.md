...
updated: 2026-05-03
type: entity
tags: [software-neuroconv, software-bids, software-nwb, neurodata-without-borders, bids, data-formats, electrophysiology, spikeinterface]
sources:
  - https://github.com/catalystneuro/neuroconv
  - https://pypi.org/project/neuroconv/
  - Rübel et al. (2022). "NeuroDataWithoutBorders (NWB): A standardized ecosystem for neuroscience data." Nature Methods.
  - Buccino et al. (2020). "SpikeInterface, a unified framework for spike sorting." eLife.
  - Nienborg et al. (2019). "Brain Imaging Data Structure (BIDS): A standardized format for organizing neuroimaging data."
