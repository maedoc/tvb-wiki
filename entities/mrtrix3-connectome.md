...
2. **Tissue Segmentation**: Automated brain extraction (e.g., using [[hd-bet]]) and tissue segmentation (gray matter, [[white-matter]], CSF) for anatomically-constrained tractography^3
