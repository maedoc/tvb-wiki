...
- Avants BB, Tustison NJ, Song G, Cook PA, Klein A, Gee JC. "Advanced normalization tools (ANTs)." NeuroImage. 2009;45(1):S173.
- Esteban O, Birman D, Schaer M, Kuyumba O, Poldrack RA, Gorgolewski KJ. "sMRIPrep: Structural MRI PREProcessing workflow." NeuroImage. 2019.
- Esteban O, Markiewicz CJ, Blair RW, et al. "fMRIPrep: a robust preprocessing pipeline for functional magnetic resonance imaging." Nat Methods. 2019;16(1):115-121.
- Gorgolewski KJ, Wolfers T, Poldrack RA. "The proliferation of reproducible neuroimaging analysis workflows." Curr Opin Neurobiol. 2017;45:65-72.
- Klein A, Andersson J, Ardekani BA, et al. "Evaluation of 14 nonlinear deformation algorithms applied to human brain MRI." NeuroImage. 2009;46(3):786-802.
- Nichols TE, Das S, Ebrahim A, et al. "Best practices in data analysis and sharing in neuroimaging using magnetic resonance imaging." NeuroImage. 2017;154:128-135.
- Taylor PA, Chen K, Luse D, et al. "A reproducible set of analysis tools for BIDS-formatted JSON." Front Neuroinform. 2018;12:27.