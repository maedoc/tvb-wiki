...
Krasimira Tsaneva-Atanasova is a Professor of Mathematics for Healthcare in the Living Systems Institute and the Department of Mathematics at the University of Exeter, United Kingdom. She received her MSc in Mathematics from the University of Plovdiv, Bulgaria, and her PhD in Applied Mathematics from the University of Auckland, New Zealand. Her research applies mathematical and computational methods to understand complex biological systems, with particular focus on hormonal signaling, neuronal excitability, and the development of quantitative tools for healthcare applications.

## Affiliations

Krasimira Tsaneva-Atanasova is a Professor of Mathematics for Healthcare at the University of Exeter, UK, where she is based in the Living Systems Institute and the Department of Mathematics. She served as Associate Dean for International and Development in the College of Engineering, Mathematics and Physical Sciences at the University of Exeter from 2018 to 2024. She has held visiting positions at the University of Bristol (Honorary Senior Research Fellow, 2013–present) and the Institute for Advanced Study at the Technical University of Munich (Hans Fischer Senior Fellowship, 2019). She is also a Fellow of the Institute of Mathematics and its Applications (2020) and served as Director of the EPSRC Hub for Quantitative Modelling in Healthcare from 2021 to 2025.
...
**Dynamical Systems and Bifurcation Theory**: Her theoretical work applies tools from dynamical systems theory—including numerical continuation, bifurcation analysis, and stability analysis—to understand how biological systems transition between different dynamical regimes. This includes studying how small parameter changes can lead to dramatic shifts in system behavior, a framework that applies across her work from hormone dynamics to neuronal excitability.

**Healthcare Modeling and Personalized Medicine**: As Director of the EPSRC Hub for Quantitative Modelling in Healthcare, she has worked on developing mathematical models for clinical applications, including personalized modeling of disease progression and treatment response. This includes work on modeling Duchenne Muscular Dystrophy progression and applications of machine learning for clinical decision support.

## Key Publications

Tsaneva-Atanasova's publications demonstrate the breadth of her computational and mathematical approach to biological systems:
...
4. E. Zavala, K.C.A. Wedgwood, M. Voliotis, J. Tabak, F. Spiga, S.L. Lightman, K. Tsaneva-Atanasova. (2019). *Mathematical Modelling of Endocrine Systems*. Trends in Endocrinology & Metabolism, 30(4):244-257. [DOI](https://doi.org/10.1016/j.tem.2019.01.008)

5. S.J. Rahi, J. Larsch, K. Pecani, N. Mansouri, A.Y. Katsov, K. Tsaneva-Atanasova, E.D. Sontag, F.R. Cross. (2017). *Oscillatory stimuli differentiate adapting circuit topologies*. Nature Methods, 14(10):1010-1016. [DOI](https://doi.org/10.1038/nmeth.4408)

6. K. Tsaneva-Atanasova, A. Burgo, T. Galli, D. Holcman. (2009). *Quantifying neurite growth mediated by interactions between secretory vesicles, microtubules and actin networks*. Biophysical Journal, 96(3):840-857. [DOI](https://doi.org/10.1016/j.bpj.2008.10.036)

7. L.A. Atherton, L.Y. Prince, K. Tsaneva-Atanasova. (2016). *Bifurcation analysis of a two-compartment hippocampal pyramidal cell model*. Journal of Computational Neuroscience, 41(1):51-64. [DOI](https://doi.org/10.1007/s10827-016-0606-8)

8. M. Voliotis, K.L. Garner, K. Tsaneva-Atanasova, C.A. McArdle. (2018). *Exploring Dynamics and Noise in Gonadotropin-Releasing Hormone (GnRH) Signaling*. Methods in Molecular Biology, 1759:193-208. [DOI](https://doi.org/10.1007/978-1-4939-8618-7_19)

9. R. Challen, E. Brooks-Pollock, J.M. Read, L. Dyson, K. Tsaneva-Atanasova, L. Danon. (2021). *Risk of mortality in patients infected with SARS-CoV-2 variant of concern 202012/1: matched cohort study*. BMJ, 372:n579. [DOI](https://doi.org/10.1136/bmj.n579)

10. P. Słowiński, K. Tsaneva-Atanasova, B. Krauskopf. (2016). *Effects of time-delay in a model of intra- and inter-personal motor coordination*. European Physical Journal Special Topics, 225(8):1497-1504. [DOI](https://doi.org/10.1140/epjst/e2015-50327-6)
