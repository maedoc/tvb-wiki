...
The emergence of GeNN and similar GPU-accelerated tools like NEST (the NEST GPU project provides GPU capabilities separately) reflects a broader trend in computational neuroscience toward hardware-accelerated simulation, complementing the rise of whole-brain modeling frameworks like [[The Virtual Brain]] that require large-scale network simulations.
