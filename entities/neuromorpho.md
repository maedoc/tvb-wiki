...
- ascoli2007neuromorpho: Ascoli, G. A., et al. (2007). Neuromorpho.org: A central repository for neuronal morphometry. *Neuroinformatics*, 5(2), 111–115.
- ascoli2015neuromorpho: Ascoli, G. A. (2015). Sharing neuron data: Carving cartography from their configuration space. *Network: Computation in Neural Systems*, 26(2-4), 73–96.
- nielsen2008noneuronsource: Nielsen, T. A., et al. (2008). Neurons: A client-server architecture for a public repository of neuronal morphologies. *Neuroinformatics*, 6(2), 117–127.
- state2020bmtk: State, M. (2020). The Brain Modeling Toolkit and its integration with the SONATA data format. *Frontiers in Neuroinformatics*, 14, 57.
- gleeson2019sonata: Gleeson, P., et al. (2019). Sonata: A fair data format for neuronal network simulations. *Frontiers in Neuroinformatics*, 13, 25.