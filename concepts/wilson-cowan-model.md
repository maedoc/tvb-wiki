...
The sigmoid functions map the total synaptic input to a firing rate between 0 and 1, capturing the nonlinear thresholding behavior of real neurons. This mean-field approach approximates the collective dynamics of large populations of spiking neurons without requiring detailed simulation of individual neurons.
