...
## ORPHAN PAGE CONTEXT (brainsmash)
---
created: 2024-01-15
sources:
...
**BrainSMASH** (Brain Surrogate Maps with Autocorrelated Spatial Heteroscedasticity) is a Python toolbox designed to generate spatially

## ORPHAN PAGE CONTEXT (iclabel)
---  
created: 2026-04-29  
sources:  
