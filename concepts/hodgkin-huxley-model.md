...
These reduced models are particularly relevant for the TVB/whole-brain ecosystem, where computational tractability across thousands of brain regions necessitates simplified neuronal dynamics while still preserving the [[bifurcation-analysis|bifurcation]] structure that gives rise to oscillations, transitions between up and down states, and pathological epileptiform activity.
