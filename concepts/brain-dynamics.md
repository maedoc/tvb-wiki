...
sources: [raw/papers/strogatz-1994.md, raw/papers/izhikevich-2007.md, raw/papers/breakspear-2017.md]
---
...
When multiple brain regions are coupled via structural connectivity, novel dynamics emerge that cannot be understood from isolated regions alone. The topology of the connectome—including modular organization, [[rich-club]] hubs, and small-world properties—shapes the patterns of synchronization and propagation that arise [[breakspear-2017]]. Network oscillations emerge through synchronization of nearly identical oscillators, described by the Kuramoto model of coupled phase oscillators [[strogatz-1994]]. Frequency-dependent phase locking and coherence resonance, where noise actually enhances oscillatory behavior, provide additional mechanisms for emergent rhythmicity. Critical brain dynamics, where the system hovers near a critical point, maximizes information processing capacity and has been observed in both experimental recordings and computational models [[breakspear-2017]].

The study of brain dynamics has revealed several canonical spatiotemporal patterns that recur across individuals and species. These include [[brain-oscillations]] across frequency bands (delta, theta, alpha, beta, gamma), traveling waves that sweep across cortical surfaces, explosive synchronization transitions similar to phase transitions in physical systems, and critical brain dynamics where the system operates near a critical point, maximizing information processing capacity. These patterns provide the mechanistic link between the structural scaffold provided by white matter pathways and the fluid functional connectivity observed in resting-state [[neuroimaging-fmri]].

## Relationship to Whole-Brain Modeling

[[whole-brain modeling]] in the tradition of [[the-virtual-brain]] takes brain dynamics as its core object of study, constructing personalized brain models by combining individual structural connectivity (from [[dti]] or [[hcp-dataset]]) with generic neural mass model dynamics. The fundamental hypothesis is that individual differences in brain dynamics arise from individual differences in structural connectivity, modulated by region-specific parameters that can be fit to empirical data [[breakspear-2017]]. This approach has been particularly successful in [[epilepsy-modeling]], where the [[epileptor]] model captures seizure onset and propagation through bifurcation dynamics, as well as in studying the effects of [[brain-stimulation]] on network dynamics, including transcranial magnetic stimulation and deep brain stimulation interventions.
...
2. Eugene M. Izhikevich. *Dynamical Systems in Neuroscience: The Geometry of Excitability and Bursting*. MIT Press, 2007.
3. Michael Breakspear. *Dynamic models of large-scale brain activity*. Nature Neuroscience, 20(3):353–364, 2017. https://doi.org/10.1038/s41593-017-0015-4