...
[1] Avitabile, D., et al. (2024). Neural field theory and local field potentials: Foundations for [[whole-brain|whole-brain modeling]]. *arXiv preprint* arXiv:2512.07842.

[2] Binz, C., et al. (2025). Population dynamics and parameter inference from electrophysiological recordings. *arXiv preprint* arXiv:2510.22022.

[3] Caravelli, F., et al. (2026). Current source density analysis and neural field equations: A unified framework. *arXiv preprint* arXiv:2603.07524.