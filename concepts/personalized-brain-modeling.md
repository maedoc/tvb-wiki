...
TractoR ([[tractography]] with R) is an open-source software package that provides tools for performing fiber tractography and [[structural-connectivity]] analysis on diffusion magnetic reson