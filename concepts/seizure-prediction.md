...
3. Susanne Ditlevsen, Massimiliano Tamborrino, Irene Tubikanec. *Network inference via approximate Bayesian computation. Illustration on a stochastic multi-population neural mass model*. [Link](https://arxiv.org/abs/2306.15787)
