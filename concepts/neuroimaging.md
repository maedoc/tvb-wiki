...
MedPy is an open-source Python library dedicated to medical image processing, providing a comprehensive tools for the analysis and manipulation of volumetric medical imaging data. Built on top of
...
**NIPAL** (Neural Integration Platform for Anatomical Levels) is a Python‑based [[neural‑simulation]] framework designed for large‑scale [[brain‑network]] modeling. It provides the computational backend for simulating neural mass dynamics at the regio

## ORPHAN PAGE CONTEXT (nitransforms)
---
created: 2025-01-15
sources:
...
NiTransforms is a Python library for handling spatial transforms in [[neuroimaging]] data [@nitransforms‑joss]. Developed and maintained by the NiPy community, it provides a unified interface

## ORPHAN PAGE CONTEXT (scot)
---
created: 2025-01-15
sources:
...
SCOT ([[structural-connectivity]] Toolbox) is a proposed or lessestablished software package designed for the analysis and visualization of structural brain [[connectivity]] data derived from diffusion tensor imaging (DTI) and