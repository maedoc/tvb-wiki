...
Nunez's work discusses how macroscopic EEG signals emerge from the coordinated activity of large neuronal populations. The textbook connects microscopic mechanisms—synaptic currents, membrane potentials—to macroscopic observables through [[mean-field-theory|mean-field]] approximations. This theoretical framework underpins the [[neural-mass-model]] approach used in many whole-brain simulators, where brain regions are represented as coupled oscillators or neural mass equations rather than as detailed spiking networks.
