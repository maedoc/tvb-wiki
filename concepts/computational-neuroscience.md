...
Computational neuroscience is the discipline that formalizes brain function as a dynamical system constrained by anatomical structure and the [[connectome]], seeking to bridge biophysical mechanism with observable neural activity patterns. At the microscopic scale, this involves simulating [[spiking-neural-networks]] with synaptic resolution; [[raw/papers/jordan-2018.md|Jordan et al. (2018)]] demonstrated that the [[nest]] simulator can weak-scale to networks comprising 10^11 synapses—approaching the scale of the human cortex—using a five-step communication scheme and memory-efficient data structures that minimize inter-node overhead. At the macroscopic scale, [[neural-mass-model|neural mass models]] and mean-field approximations capture population-level dynamics governed by [[nonlinear-dynamics|nonlinear differential equations]], with [[raw/papers/strogatz-1994.md|Strogatz (1994)]] providing the foundational treatment of [[bifurcation-analysis|bifurcation theory]], limit cycles, and strange attractors that supplies the mathematical vocabulary for analyzing transitions in brain states such as [[epilepsy-modeling|seizure onset]]. The link between these computational scales and neuroimaging is established through the concept of [[functional-connectivity]], which [[raw/papers/friston-1993.md|Friston et al. (1993)]] originally defined as the temporal correlation between spatially remote neurophysiological events and extracted via principal component analysis of [[neuroimaging-pet|PET]] and [[fmri]] data. Despite these advances, the field has historically treated scales in isolation; [[raw/papers/semanticscholar-eb704b6f5462.md|Hater et al. (2026)]] address this by presenting a [[co-simulation]] framework that couples the Arbor spiking simulator with [[the-virtual-brain|TVB]] through an MPI intercommunicator, enabling bidirectional translation between discrete spikes and continuous mean-field activity to study seizure generation and whole-brain propagation. Meanwhile, [[raw/papers/arxiv-2603.07524.md|Jiang et al. (2026)]] argue that dominant network construction methods relying on pre-defined atlases and linear assumptions fail to capture the heterogeneous spatial patterns of neural dynamics, and propose a neural dynamics-informed pre-trained framework for [[personalized-brain-modeling|personalized brain functional network construction]]. Together, these strands illustrate computational neuroscience as an inherently multiscale endeavor spanning biophysical realism, dynamical systems theory, and clinical neuroimaging.
