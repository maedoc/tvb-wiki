...
updated: 2026-05-06
type: concept
tags: [brain-parcellation, atlas, connectivity, nodes, regions]
sources: []
---

# Brain Parcellation

**Brain parcellation** is the process of dividing the brain into discrete regions (nodes) for analysis. It is a foundational step in whole-brain modeling and connectivity analysis.
...
- Node dynamics are modeled by neural mass or mean-field equations
