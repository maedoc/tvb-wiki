...
KNOWN_SOFTWARE = {
    ...
    'tvb-nest': 'TVB-NEST co-simulation',
    'pynn': 'PyNN',
    'annarchy': 'ANNarchy',
    'bluepyopt': 'BluePyOpt',
    ...
    'hcp-pipelines': 'HCP Pipelines',
    'cmtk': 'CMTK',
    'brain-life': 'Brainlife.io',
    'brain-map': 'Brain Map',
...
OFF_MISSION_BLACKLIST = {
    ...
    # Generic neuroimaging tools NOT directly integrated with TVB
    'brian', 'brian2', 'coreneuron', 'dynasim', 'fieldtrip', 'freesurfer',
    'fsl', 'spm', 'mne-python', 'nilearn', 'dipy', 'mrtrix', 'mrtrix3',
    'ants', 'antspy', 'brainstorm', 'nwb', 'neuroconstruct', 'netpyne',
    'pynn', 'simnibs', 'software-bct', 'software-fsl', 'software-spm',
    'modeldb', 'fsleyes', 'cat12', 'steps', 'itk-snap',
