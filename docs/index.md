...
A knowledge base for whole-brain simulation, neural mass models, and neuroimaging integration. From the Wilson-Cowan model to TVB platform tutorials.
...
-   :fontawesome-solid-graduation-cap: **New to TVB?**
    ...
    Learn the basics of whole-brain modeling and how TVB enables personalized brain simulation.
...
-   :fontawesome-solid-brain: **Neural Models**
    ...
    Dive deep into population-level brain models and their applications.
...
-   :fontawesome-solid-scale-balanced: **Compare Tools**
    ...
    Compare simulation platforms and choose the right tool for your research.
...
### :material-test-tube: Neural Mass Models: A Comprehensive Overview
...
[:fontawesome-solid-brain: **Neuroimaging**](concepts/index.md){ .md-button }
[:fontawesome-solid-network-wired: **Connectivity**](concepts/connectome.md){ .md-button }
[:fontawesome-solid-calculator: **Neural Models**](concepts/neural-mass-model.md){ .md-button }
[:fontawesome-solid-square-root-variable: **Mathematics**](concepts/dynamical-systems-theory.md){ .md-button }
[:fontawesome-solid-laptop-code: **Software**](entities/index.md){ .md-button }
[:fontawesome-solid-hospital: **Clinical**](concepts/epilepsy-modeling.md){ .md-button }

</div>

<div class="grid" markdown>

[:fontawesome-solid-baby: **Development**](concepts/neurodevelopment.md){ .md-button }
[:fontawesome-solid-person-cane: **Aging**](concepts/aging.md){ .md-button }
[:fontawesome-solid-microscope: **Methods**](concepts/dynamic-causal-modeling.md){ .md-button }
...
This is a living knowledge base for computational neuroscience, automatically enriched from arXiv papers and curated by the research community.

| | |
|:---|:---|
| **Pages** | 183 across concepts, entities, and comparisons |
| **Updated** | April 23, 2026 |
| **Powered by** | Feynman research tools |
| **License** | CC BY-SA 4.0 |

[:fontawesome-solid-code: Contribute](https://github.com/maedoc/tvb-wiki){ .md-button }
[:fontawesome-solid-book: Schema](SCHEMA.md){ .md-button }
[:fontawesome-solid-circle-info: About](about.md){ .md-button }
