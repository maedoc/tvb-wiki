...
**Intrinsic Connectivity Networks (ICNs)** are spatially distributed brain systems whose constituent regions exhibit temporally correlated [[spontaneous-activity]] during task-free conditions. They are typically identified from spontaneous low-frequency fluctuations in the [[bold-signal]] measured during [[resting-state-fmri]], and they provide a data-driven decomposition of the brain's functional architecture that persists even in the absence of explicit external stimulation.
...
Following this validation, [[raw/papers/power-2011.md|Power et al. (2011)]] produced a comprehensive spatial mapping of major functional systems, creating reference atlases that are now widely adopted for comparing simulated and empirical functional connectivity patterns. Their work identified canonical networks including the [[default-mode-network]], attention, sensorimotor, and visual systems—each anchored to specific cortical and subcortical territories. These atlases have become essential benchmarks in connectome-based modeling, where simulated [[functional-connectivity]] matrices are evaluated against empirical ICN topologies derived from large repositories such as the [[hcp-dataset]]. [[raw/papers/power-2011.md|Power et al. (2011)]]
