...
7. Wenqi Zhu, Zhong Yin, Yinghua Fu. (2026). *CGLK-GNN : A connectome generation network with large kernels for GNN based [[alzheimers-disease|Alzheimer's disease]] analysis*. Neural Networks. [DOI](](https://doi.org/10.1016/j.neunet.2026.108689))
