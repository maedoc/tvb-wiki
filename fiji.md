...
- Ackermann, M. & Schindelin, J. (2014). ImageJ2: An extensible Java library for scientific image analysis. *Nature Methods*, 11(8), 805-806.
- Linkert, M., Rueden, C.T., Allan, C., Burel, J.M., Moore, W., Patterson, A., ... & Carpenter, A.E. (2010). Bio-Formats: an open-source software for managing microscopy image format data. *Bioinformatics*, 26(7), 932-939.
- Arganda-Carreras, I., Kaynig, V., Rueden, C., Eliceiri, K.W., Schindelin, J., Cardona, A., & Sebastian, H. (2017). Trainable Weka Segmentation: a machine learning tool for microscopy image classification. *Nature Methods*, 14(2), 122-123.