...
[1]: Gorgolewski, K., et al. (2016). Brain Imaging Data Structure: A community-driven standard for organizing and sharing neuroimaging data. *NeuroImage*, 124, 1244-1249.

[2]: Gorgolewski, K., et al. (2016). Brain Imaging Data Structure: A community-driven standard for organizing and sharing neuroimaging data. *NeuroImage*, 124, 1244-1249.

[3]: YAML frontmatter reference for BIDS validator and pybids tools.

[4]: Referring to diffusion MRI processing tools commonly used with BIDS datasets.

[5]: Gorgolewski, K., et al. (2016). Nipype: A flexible, lightweight and extensible neuroimaging data processing framework in Python. *Frontiers in Neuroinformatics*, 5, 13.