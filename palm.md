...
PALM (Parametric Analysis of Linear Models) is a statistical inference tool whose foundations rest on a 2014 framework for permutation-based inference in neuroimaging presented by Winkler, Ridgway, Webster, Smith, and Nichols [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]]. The authors tackle the multiple comparisons problem inherent in whole-brain analysis by uniting permutation tests with the general linear model (GLM), producing a methodology suited to the thousands of simultaneous tests required when mapping activity across voxels or vertices in [[fmri]] and related imaging modalities [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]]. Because inference proceeds from empirically generated null distributions rather than from parametric assumptions of normality, the framework remains valid when sample sizes are small and variance structures are heterogeneous, situations that frequently arise in [[neuroimaging]] studies [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]].

A central contribution of the work is the generalized statistic *G*, constructed to be robust under heteroscedasticity, alongside permutation strategies that accommodate complex experimental designs through exchangeability blocks and nuisance variables [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]]. The authors compare alternative methods—including Freedman-Lane and Smith strategies—and derive guidelines for selecting the appropriate approach under different conditions, thereby formalizing practical choices in high-dimensional GLM inference [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]]. These statistical foundations provide a rigorous basis for validating simulated brain dynamics against empirical measurements in [[whole-brain-modeling]] pipelines, and support principled hypothesis testing about [[brain-network]] architecture and [[parameter-estimation]] [[raw/papers/winkler-2014-palm.md|Winkler et al. (2014)]].
