...
## [2026-05-03]
- Improved meg-eeg-toolbox page: created comprehensive entity page for FieldTrip (MEG/EEG Toolbox) replacing placeholder content. Added overview of Donders Institute MATLAB toolbox for MEG/EEG/iEEG analysis, detailed technical sections on preprocessing, time-frequency analysis, source reconstruction (dipoles, distributed sources, beamformers), connectivity analysis, and statistical inference. Included relationship to TVB for empirical data analysis, validation, and personalization of whole-brain models. Related software connections to SPM, EEGLAB, MNE-Python, and Brain Connectivity Toolbox. Added 12+ wikilinks to existing pages (the-virtual-brain, brain-oscillations, spm, eeglab, personalized-brain-modeling, source-localization, connectivity, connectivity-types, brain-connectivity-toolbox, mne-python, whole-brain-modeling, functional-connectivity). Updated frontmatter tags to taxonomy-compliant entries (software, neuroimaging-meg, neuroimaging-eeg, software-fieldtrip, source-localization, time-frequency-analysis, connectivity, electrophysiology)
- Improved palm page: created comprehensive entity page for PALM (Parametric Analysis of Linear Models) replacing placeholder content. Added overview explaining PALM as FSL-based statistical inference engine for neuroimaging data analysis with emphasis on permutation testing and Bayesian model comparison. Included motivation on multiple comparisons problem in whole-brain analyses and limitations of parametric assumptions. Detailed technical sections on permutation-based inference, TFCE, Bayes factors for linear models, and flexible linear model specification. Added relationship to TVB for statistical validation of whole-brain model predictions and parameter estimation via Bayesian model comparison. Related software connections to FSL, SPM, AFNI, Brain Connectivity Toolbox. Added 10+ wikilinks to existing pages (fsl, the-virtual-brain, spm, afni, brain-connectivity-toolbox, neuroimaging, fmri, resting-state, functional-connectivity, brain-dynamics, whole-brain-modeling, neural-mass-models, parameter-estimation, bayes-factors, variational-bayes, brain-oscillations, brain-network, connectome, computational-neuroscience, dynamic-causal-modeling, free-energy-principle). Updated frontmatter tags to taxonomy-compliant entries
