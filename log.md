...
## [2026-05-03]
- Improved PALM page: created comprehensive software entity page replacing placeholder content. Added overview of Permutation Analysis of Linear Models toolbox for non-parametric neuroimaging inference, detailed technical sections on permutation framework, TFCE implementation, computational architecture. Included relationship to TVB and whole-brain modeling workflows, related software (fsl-randomise, SPM, nilearn, nipype), 11+ wikilinks to related pages (whole-brain-modeling, structural-connectivity, neural-mass-models, functional-connectivity, brain-network, fsl, spm, nipype, nifti, connectome-workbench), updated frontmatter tags to taxonomy-compliant entries (software-fsl, neuroimaging-fmri, neuroimaging-pet, parameter-estimation, variational-bayes)
