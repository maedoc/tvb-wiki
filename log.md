...
## [2026-05-03]
- Improved BrainMap page: created comprehensive entity page replacing placeholder content. Added overview explaining BrainMap as database and software ecosystem for coordinate-based meta-analysis of neuroimaging data, developed by Brain Mapping Laboratory at UT Austin. Detailed Key Features covering BrainMap database (10,000+ experiments with MNI/Talairach coordinates, CogAtlas taxonomy), Sleuth search interface, and GingerALE implementation of Activation Likelihood Estimation (ALE) algorithm. Included Methodology section explaining ALE spatial probability modeling, permutation-based inference, meta-analytic connectivity modeling (MACM), and meta-analytic decoding. Relationship to TVB section explains how BrainMap provides activation priors for constraining whole-brain models and validating simulated functional connectivity. Added Key Papers referencing foundational ALE papers (Turkeltaub 2002, Laird 2005, Eickhoff 2009/2012). Related Software section linking to neurosynth, neurovault, spm, fsl, brainnet-viewer, and the-virtual-brain. Included 15+ wikilinks to existing pages (the-virtual-brain, whole-brain-modeling, neural-mass-model, connectome, resting-state, neuroimaging, neurosynth, neurovault, human-connectome-project, brain-network, functional-connectivity, diffusion-imaging, tractography, fmri, dynamic-causal-modeling). Updated frontmatter tags to taxonomy-compliant entries (database, software, neuroimaging, meta-analysis, activation-likelihood-estimation).
